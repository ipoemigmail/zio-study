...
object CreatingEffectSpec extends DefaultRunnableSpec {
  def spec: ZSpec[Environment, Failure] =
    suite("CreatingEffect")(
      ...
      suite("From Success Values")(
        ...
        testM("Try") {
          assertM(ZIO.fromTry(Try(42 / 0)).refineToOrDie[ArithmeticException].run)(
      ...
      suite("From Side-Effects")(
        suite("Synchronous Side-Effects")(
          ...
          testM("From Side-Effects") {
            assertM(ZIO.effect(throw new IOException("")).refineToOrDie[IOException].run)(
